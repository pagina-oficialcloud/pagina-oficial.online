...
//=======================
    ...
    function testimonialActiveCRM($scope, $) {
    ...
    function instagramActive($scope, $) {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/int-template-slider.default', templateSlider);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-testimonial.default', testimonialActive);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-instagram.default', instagramActive);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-hero-two.default', heroTwoActive);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-testimonial-crm.default', testimonialActiveCRM);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-brand-two.default', brandActive);
        elementorFrontend.hooks.addAction('frontend/element_ready/int-testimonial-two.default', testimonialSliderActive);
    });
